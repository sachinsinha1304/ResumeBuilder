    ...
    let html = details.education.map((ele,idx)=>
        <div className='box-individual-item' key={idx}>
            ...
            <div className="mb-3 row">
                ...
                <div className="col-sm-10">
                <input type="date" className="form-control" name='startDate' onChange={(e)=>updateEducation(e, idx)} value={ele['value'].startDate} />
                </div>
            </div>
            <div className="mb-3 row">
                <label  className="col-sm-2 col-form-label">End Year</label>
                <div className="col-sm-10">
                <input type="date" className="form-control" name='endDate' onChange={(e)=>updateEducation(e, idx)} value={ele['value'].endDate} />
                </div>
            </div>
            <div className="mb-3 row">
                <label  className="col-sm-2 col-form-label">Percentage/CGPA</label>
                <div className="col-sm-10">
                <input type="text" className="form-control" name='cgpa' onChange={(e)=>updateEducation(e, idx)} value={ele['value'].cgpa} />
                </div>
            </div>
        </div>
