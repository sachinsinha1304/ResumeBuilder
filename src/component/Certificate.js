    ...
    let html = details.certificate.map((ele,idx)=>
        <div className='box-individual-item' key={idx}>
            ...
            <div className="mb-3 row">
                ...
                <div className="col-sm-10">
                <input type="date" className="form-control" name='startDate' onChange={(e)=>updateCertificate(e, idx)} value={ele['value'].startDate} />
                </div>
            </div>
            <div className="mb-3 row">
                <label  className="col-sm-2 col-form-label">End Year</label>
                <div className="col-sm-10">
                <input type="date" className="form-control" name='endDate' onChange={(e)=>updateCertificate(e, idx)} value={ele['value'].endDate} />
                </div>
            </div>
            <div className="mb-3 row">
